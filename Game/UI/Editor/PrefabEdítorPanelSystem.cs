...
// Type: Game.UI.Editor.PrefabEdítorPanelSystem
...
namespace Game.UI.Editor
{
  ...
  public class PrefabEdítorPanelSystem : EditorPanelSystemBase
  {
    ...
    private PrefabEdítorPanelSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_Adapter.EventPrefabSelected += (Action<PrefabBase>) (prefab =>
      {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        this.m_InspectorPanelSystem.SelectPrefab(prefab);
        // ISSUE: reference to a compiler-generated field
        this.activeSubPanel = (IEditorPanel) this.m_InspectorPanelSystem;
      });
      this.title = (LocalizedString) "Editor.TOOL[PrefabEditorTool]";
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      IWidget[] widgetArray1 = new IWidget[5]
      {
      ...
      hierarchyMenu1.path = (PathSegment) "PrefabEditorToolCategories";
      ...
      button.displayName = (LocalizedString) "Editor.CREATE_NEW_PREFAB";
      // ISSUE: reference to a compiler-generated method
      button.action = (System.Action) (() => this.activeSubPanel = (IEditorPanel) new TypePickerPanel((LocalizedString) "Editor.CREATE_NEW_PREFAB", (LocalizedString) "Editor.PREFAB_TYPES", (IEnumerable<Item>) this.GetPrefabTypeItems().ToList<Item>(), (TypePickerPanel.SelectCallback) (type =>
      {
        this.CloseSubPanel();
        PrefabBase instance = (PrefabBase) ScriptableObject.CreateInstance(type);
        instance.name = type.Name;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        this.m_PrefabSystem.AddPrefab(instance);
        // ISSUE: reference to a compiler-generated method
        this.OnPrefabSelected(instance);
      }), new System.Action(((EditorPanelSystemBase) this).CloseSubPanel)));
      widgetArray1[4] = (IWidget) button;
    ...
    protected override void OnUpdate()
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        this.m_PrefabsDirty = true;
      }
      // ISSUE: reference to a compiler-generated field
      if (this.m_PrefabsDirty && this.activeSubPanel == null)
      {
        // ISSUE: reference to a compiler-generated method
        this.UpdatePrefabs();
      }
    ...
    private void GenerateCategories()
    {
      ...
      editorAssetCategory.entityQuery = this.GetEntityQuery(new EntityQueryDesc()
      {
        ...
        {
          ComponentType.ReadOnly<Game.Prefabs.MeshData>()
        }
      });
    ...
    {
      // ISSUE: reference to a compiler-generated method
      this.activeSubPanel = (IEditorPanel) new TypePickerPanel((LocalizedString) "Editor.CREATE_NEW_PREFAB", (LocalizedString) "Editor.PREFAB_TYPES", (IEnumerable<Item>) this.GetPrefabTypeItems().ToList<Item>(), (TypePickerPanel.SelectCallback) (type =>
      {
        this.CloseSubPanel();
        PrefabBase instance = (PrefabBase) ScriptableObject.CreateInstance(type);
        instance.name = type.Name;
    ...
    private void OnCreatePrefab(System.Type type)
    {
      this.CloseSubPanel();
      PrefabBase instance = (PrefabBase) ScriptableObject.CreateInstance(type);
      instance.name = type.Name;
    ...
    {
      foreach (System.Type element in TypePickerPanel.GetAllConcreteTypesDerivedFrom<PrefabBase>())
      {
        ComponentMenu customAttribute = element.GetCustomAttribute<ComponentMenu>();
        yield return new Item()
        {
          type = element,
          name = WidgetReflectionUtils.NicifyVariableName(element.Name),
