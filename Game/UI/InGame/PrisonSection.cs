...
// Type: Game.UI.InGame.PrisonSection
...
namespace Game.UI.InGame
{
  ...
  {
    protected override string group => nameof (PrisonSection);
    ...
    private bool Visible() => this.EntityManager.HasComponent<Game.Buildings.Prison>(this.selectedEntity);
    ...
    protected override void OnProcess()
    {
      ...
      if (this.TryGetComponentWithUpgrades<PrisonData>(this.selectedEntity, this.selectedPrefab, out data))
        this.prisonerCapacity = data.m_PrisonerCapacity;
