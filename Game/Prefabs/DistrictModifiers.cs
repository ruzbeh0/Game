...
// Type: Game.Prefabs.DistrictModifiers
...
namespace Game.Prefabs
{
  ...
  public class DistrictModifiers : ComponentBase
  {
    ...
    public override void Initialize(EntityManager entityManager, Entity entity)
    {
      ...
      {
        DistrictModifierInfo modifier = this.m_Modifiers[index];
        buffer.Add(new DistrictModifierData(modifier.m_Type, modifier.m_Mode, modifier.m_Range));
      }
    }
  }
}
