...
namespace Game.Prefabs
{
  ...
  public class ParkPrefab : PrefabBase
  {
    ...
    public override void LateInitialize(EntityManager entityManager, Entity entity)
    {
      ...
      entityManager.SetComponentData<ParkParameterData>(entity, new ParkParameterData()
      {
        m_ParkServicePrefab = systemManaged.GetEntity(this.m_ParkServicePrefab)
      });
    }
  }
}
