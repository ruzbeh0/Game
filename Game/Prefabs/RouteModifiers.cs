...
// Type: Game.Prefabs.RouteModifiers
...
namespace Game.Prefabs
{
  ...
  public class RouteModifiers : ComponentBase
  {
    ...
    public override void Initialize(EntityManager entityManager, Entity entity)
    {
      ...
      {
        RouteModifierInfo modifier = this.m_Modifiers[index];
        buffer.Add(new RouteModifierData(modifier.m_Type, modifier.m_Mode, modifier.m_Range));
      }
    }
  }
}
