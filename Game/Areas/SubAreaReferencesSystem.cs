...
// Type: Game.Areas.SubAreaReferencesSystem
...
namespace Game.Areas
{
  ...
  public class SubAreaReferencesSystem : GameSystemBase
  {
    ...
    private SubAreaReferencesSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      this.m_SubAreaQuery = this.GetEntityQuery(new EntityQueryDesc()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.RequireForUpdate(this.m_SubAreaQuery);
    }
    ...
    protected override void OnUpdate()
    {
      ...
      SubAreaReferencesSystem.UpdateSubAreaReferencesJob jobData = new SubAreaReferencesSystem.UpdateSubAreaReferencesJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<SubAreaReferencesSystem.UpdateSubAreaReferencesJob>(this.m_SubAreaQuery, this.Dependency);
    }
        ...
        in v128 chunkEnabledMask)
      {
        ...
        if (chunk.Has<Created>(ref this.m_CreatedType))
        {
          ...
          if (chunk.Has<Temp>(ref this.m_TempType))
          {
            for (int index = 0; index < nativeArray2.Length; ++index)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (this.m_TempData.HasComponent(owner.m_Owner) && this.m_SubAreas.HasBuffer(owner.m_Owner))
              {
                // ISSUE: reference to a compiler-generated field
                CollectionUtils.TryAddUniqueValue<SubArea>(this.m_SubAreas[owner.m_Owner], new SubArea(nativeArray1[index]));
              }
            }
          }
          else
          {
            for (int index = 0; index < nativeArray2.Length; ++index)
            {
              ...
              Owner owner = nativeArray2[index];
              // ISSUE: reference to a compiler-generated field
              if (this.m_SubAreas.HasBuffer(owner.m_Owner))
              {
                // ISSUE: reference to a compiler-generated field
                CollectionUtils.TryAddUniqueValue<SubArea>(this.m_SubAreas[owner.m_Owner], new SubArea(area));
              }
            }
          }
        }
        else
        {
          for (int index = 0; index < nativeArray1.Length; ++index)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              CollectionUtils.RemoveValue<SubArea>(this.m_SubAreas[owner.m_Owner], new SubArea(area));
            }
          }
        }
      }
