...
// Type: Game.Serialization.SubNetSystem
...
{
  [CompilerGenerated]
  public class SubNetSystem : GameSystemBase
  {
    private EntityQuery m_Query;
    private SubNetSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      SubNetSystem.SubNetJob jobData = new SubNetSystem.SubNetJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<SubNetSystem.SubNetJob>(this.m_Query, this.Dependency);
    }
    ...
    [BurstCompile]
    private struct SubNetJob : IJobChunk
    {
      [ReadOnly]
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray2.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          if (this.m_SubNets.HasBuffer(owner.m_Owner))
          {
            // ISSUE: reference to a compiler-generated field
            this.m_SubNets[owner.m_Owner].Add(new SubNet(subNet));
          }
        }
      }
