...
// Type: Game.Serialization.CitizenSystem
...
namespace Game.Serialization
{
  ...
  public class CitizenSystem : GameSystemBase
  {
    ...
    private CitizenSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      CitizenSystem.CitizenJob jobData = new CitizenSystem.CitizenJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<CitizenSystem.CitizenJob>(this.m_Query, this.Dependency);
    }
    ...
    private struct CitizenJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray2.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          Entity prefab = CitizenInitializeSystem.GetPrefab(this.m_CitizenPrefabs, nativeArray2[index], this.m_CitizenDatas, random);
