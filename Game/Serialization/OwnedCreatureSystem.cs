...
// Type: Game.Serialization.OwnedCreatureSystem
...
namespace Game.Serialization
{
  ...
  public class OwnedCreatureSystem : GameSystemBase
  {
    ...
    private OwnedCreatureSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      this.m_Query = this.GetEntityQuery(ComponentType.ReadOnly<Creature>(), ComponentType.ReadOnly<Owner>());
      // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      OwnedCreatureSystem.OwnedVehicleJob jobData = new OwnedCreatureSystem.OwnedVehicleJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<OwnedCreatureSystem.OwnedVehicleJob>(this.m_Query, this.Dependency);
    }
