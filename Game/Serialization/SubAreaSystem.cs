...
// Type: Game.Serialization.SubAreaSystem
...
namespace Game.Serialization
{
  ...
  public class SubAreaSystem : GameSystemBase
  {
    ...
    private SubAreaSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      this.m_Query = this.GetEntityQuery(ComponentType.ReadOnly<Area>(), ComponentType.ReadOnly<Owner>());
      // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      SubAreaSystem.SubAreaJob jobData = new SubAreaSystem.SubAreaJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<SubAreaSystem.SubAreaJob>(this.m_Query, this.Dependency);
    }
    ...
    private struct SubAreaJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray2.Length; ++index)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            this.m_SubAreas[owner.m_Owner].Add(new SubArea(area));
          }
        }
      }
