...
// Type: Game.Serialization.HouseholdCitizenSystem
...
namespace Game.Serialization
{
  ...
  public class HouseholdCitizenSystem : GameSystemBase
  {
    ...
    private HouseholdCitizenSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_Query = this.GetEntityQuery(ComponentType.ReadOnly<HouseholdMember>());
      // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      HouseholdCitizenSystem.HouseholdCitizenJob jobData = new HouseholdCitizenSystem.HouseholdCitizenJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<HouseholdCitizenSystem.HouseholdCitizenJob>(this.m_Query, this.Dependency);
      // ISSUE: reference to a compiler-generated field
    ...
    private struct HouseholdCitizenJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray2.Length; ++index)
        {
          ...
          HouseholdMember householdMember = nativeArray2[index];
          // ISSUE: reference to a compiler-generated field
          if (this.m_HouseholdCitizens.HasBuffer(householdMember.m_Household))
          {
            // ISSUE: reference to a compiler-generated field
            this.m_HouseholdCitizens[householdMember.m_Household].Add(new HouseholdCitizen()
            {
              m_Citizen = e
            });
          }
