...
// Type: Game.Objects.SubObjectReferencesSystem
...
namespace Game.Objects
{
  ...
  public class SubObjectReferencesSystem : GameSystemBase
  {
    ...
    private SubObjectReferencesSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      SubObjectReferencesSystem.UpdateSubObjectReferencesJob jobData = new SubObjectReferencesSystem.UpdateSubObjectReferencesJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<SubObjectReferencesSystem.UpdateSubObjectReferencesJob>(this.m_ObjectQuery, this.Dependency);
    }
