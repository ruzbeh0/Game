...
// Type: Game.Simulation.ResidentAISystem
...
namespace Game.Simulation
{
  ...
  public class ResidentAISystem : GameSystemBase
  {
    ...
    [EnumArray(typeof (ResidentAISystem.DeletedResidentType))]
    [DebugWatchValue]
    private NativeArray<int> m_DeletedResidents;
    private ResidentAISystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Buildings_AttractivenessProvider_RO_ComponentLookup.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Citizens_CoordinatedMeeting_RO_ComponentLookup.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Citizens_AttendingMeeting_RO_ComponentLookup.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Citizens_HouseholdNeed_RO_ComponentLookup.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Creatures_Human_RW_ComponentLookup.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__EntityStorageInfoLookup.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Creatures_Divert_RW_ComponentTypeHandle.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Creatures_Resident_RW_ComponentTypeHandle.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      ResidentAISystem.ResidentTickJob jobData = new ResidentAISystem.ResidentTickJob()
      {
        ...
        m_ResidentType = this.__TypeHandle.__Game_Creatures_Resident_RW_ComponentTypeHandle,
        ...
        m_DivertType = this.__TypeHandle.__Game_Creatures_Divert_RW_ComponentTypeHandle,
        m_EntityLookup = this.__TypeHandle.__EntityStorageInfoLookup,
        m_HumanData = this.__TypeHandle.__Game_Creatures_Human_RW_ComponentLookup,
        ...
        m_SpawnLocation = this.__TypeHandle.__Game_Objects_SpawnLocation_RO_ComponentLookup,
        m_AnimalData = this.__TypeHandle.__Game_Creatures_Animal_RO_ComponentLookup,
        m_Dispatched = this.__TypeHandle.__Game_Simulation_Dispatched_RO_ComponentLookup,
        ...
        m_HouseholdNeedData = this.__TypeHandle.__Game_Citizens_HouseholdNeed_RO_ComponentLookup,
        m_AttendingMeetingData = this.__TypeHandle.__Game_Citizens_AttendingMeeting_RO_ComponentLookup,
        m_CoordinatedMeetingData = this.__TypeHandle.__Game_Citizens_CoordinatedMeeting_RO_ComponentLookup,
        m_MovingAwayData = this.__TypeHandle.__Game_Agents_MovingAway_RO_ComponentLookup,
        m_ServiceAvailableData = this.__TypeHandle.__Game_Companies_ServiceAvailable_RO_ComponentLookup,
        ...
        m_AttractivenessProviderData = this.__TypeHandle.__Game_Buildings_AttractivenessProvider_RO_ComponentLookup,
        ...
        m_AccessLaneLaneData = this.__TypeHandle.__Game_Routes_AccessLane_RO_ComponentLookup,
        ...
        m_PrefabIndustrialProcessData = this.__TypeHandle.__Game_Prefabs_IndustrialProcessData_RO_ComponentLookup,
      ...
      // ISSUE: reference to a compiler-generated field
      JobHandle dependsOn = jobData.ScheduleParallel<ResidentAISystem.ResidentTickJob>(this.m_CreatureQuery, JobHandle.CombineDependencies(this.Dependency, jobHandle1));
      // ISSUE: reference to a compiler-generated field
      jobData.m_GroupMember = true;
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle2 = jobData.ScheduleParallel<ResidentAISystem.ResidentTickJob>(this.m_GroupCreatureQuery, dependsOn);
      // ISSUE: reference to a compiler-generated field
    ...
    public struct Boarding
    {
      ...
      public ResidentAISystem.BoardingType m_Type;

      public static ResidentAISystem.Boarding ExitVehicle(
        Entity passenger,
        Entity household,
        Entity vehicle,
        ...
        int ticketPrice)
      {
        ...
        return new ResidentAISystem.Boarding()
        {
          ...
          m_Type = ResidentAISystem.BoardingType.Exit
        };
      }

      public static ResidentAISystem.Boarding TryEnterVehicle(
        Entity passenger,
        Entity leader,
        Entity vehicle,
        ...
        CreatureVehicleFlags flags)
      {
        ...
        return new ResidentAISystem.Boarding()
        {
          ...
          m_Position = position,
          m_Flags = flags,
          m_Type = ResidentAISystem.BoardingType.TryEnter
        };
      }

      public static ResidentAISystem.Boarding FinishEnterVehicle(
        Entity passenger,
        Entity household,
        Entity vehicle,
        ...
        int ticketPrice)
      {
        ...
        return new ResidentAISystem.Boarding()
        {
          ...
          m_TicketPrice = ticketPrice,
          m_Type = ResidentAISystem.BoardingType.FinishEnter
        };
      }

      public static ResidentAISystem.Boarding CancelEnterVehicle(Entity passenger, Entity vehicle)
      {
        // ISSUE: object of a compiler-generated type is created
        return new ResidentAISystem.Boarding()
        {
          m_Passenger = passenger,
          m_Vehicle = vehicle,
          m_Type = ResidentAISystem.BoardingType.CancelEnter
        };
      }

      public static ResidentAISystem.Boarding RequireStop(
        Entity passenger,
        Entity vehicle,
        float3 position)
      {
        ...
        return new ResidentAISystem.Boarding()
        {
          ...
          m_Vehicle = vehicle,
          m_Position = position,
          m_Type = ResidentAISystem.BoardingType.RequireStop
        };
      }

      public static ResidentAISystem.Boarding WaitTimeExceeded(Entity passenger, Entity waypoint)
      {
        // ISSUE: object of a compiler-generated type is created
        return new ResidentAISystem.Boarding()
        {
          m_Passenger = passenger,
          m_Waypoint = waypoint,
          m_Type = ResidentAISystem.BoardingType.WaitTimeExceeded
        };
      }
      ...
      public static ResidentAISystem.Boarding FinishExitVehicle(Entity passenger, Entity vehicle)
      {
        // ISSUE: object of a compiler-generated type is created
        return new ResidentAISystem.Boarding()
        {
          m_Passenger = passenger,
          m_Vehicle = vehicle,
          m_Type = ResidentAISystem.BoardingType.FinishExit
        };
      }
    }
    ...
    public struct ResidentAction
    {
      ...
      public ResidentAISystem.ResidentActionType m_Type;
      public int m_Amount;
    ...
    private struct ResidentTickJob : IJobChunk
    {
        ...
        ref Divert divert)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.AddDeletedResident(ResidentAISystem.DeletedResidentType.InvalidVehicleTarget);
          // ISSUE: reference to a compiler-generated field
        ...
        else
        {
          ...
          if ((currentVehicle.m_Flags & CreatureVehicleFlags.Ready) == (CreatureVehicleFlags) 0)
          {
            if (hasCurrentLane)
            {
              ...
              {
                // ISSUE: reference to a compiler-generated method
                this.AddDeletedResident(ResidentAISystem.DeletedResidentType.StuckLoop);
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.AddComponent<Deleted>(jobIndex, entity, new Deleted());
                return;
              }
              ...
              else if (CreatureUtils.PathEndReached(currentLane) || CreatureUtils.RequireNewPath(pathOwner))
              {
                // ISSUE: reference to a compiler-generated method
                if (ResidentAISystem.ResidentTickJob.ShouldFinishEnterVehicle(navigation))
                {
                  // ISSUE: reference to a compiler-generated method
          ...
          {
            // ISSUE: reference to a compiler-generated method
            if (ResidentAISystem.ResidentTickJob.ShouldFinishExitVehicle(navigation))
            {
              // ISSUE: reference to a compiler-generated method
        ...
        else
        {
          ...
          if (divert.m_Purpose == Game.Citizens.Purpose.None && !this.m_EntityLookup.Exists(target.m_Target))
          {
            ...
            if (this.m_HealthProblemData.TryGetComponent(resident.m_Citizen, out componentData) && (componentData.m_Flags & HealthProblemFlags.RequireTransport) != HealthProblemFlags.None && (componentData.m_Flags & (HealthProblemFlags.Dead | HealthProblemFlags.Injured)) != HealthProblemFlags.None)
            {
              ...
              {
                // ISSUE: reference to a compiler-generated method
                this.AddDeletedResident(ResidentAISystem.DeletedResidentType.Dead);
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.AddComponent<Deleted>(jobIndex, entity, new Deleted());
                return;
              }
      ...
      private unsafe void AddDeletedResident(ResidentAISystem.DeletedResidentType type)
      {
        // ISSUE: reference to a compiler-generated field
        ...
        HouseholdNeed householdNeed)
      {
        ...
        if (this.m_ConnectedBuildings.HasBuffer(element))
        {
          ...
          {
            int a = num1 + index1;
            int index2 = math.select(a, a - connectedBuilding.Length, a >= connectedBuilding.Length);
        ...
        ref Game.Creatures.Resident resident)
      {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        ResidentAISystem.ResidentTickJob.TransportEstimateBuffer transportEstimateBuffer = new ResidentAISystem.ResidentTickJob.TransportEstimateBuffer()
        {
        ...
        ref Game.Common.Target target)
      {
        ...
        {
          PathUtils.CopyPath(pathElement2, sourceOwner, 0, pathElement1);
          pathOwner.m_ElementIndex = 0;
        ...
        ref PathOwner pathOwner)
      {
        ...
        if (homeBuilding == Entity.Null || this.m_DestroyedData.HasComponent(homeBuilding))
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.AddDeletedResident(ResidentAISystem.DeletedResidentType.WaitingHome_AlreadyOutside);
          // ISSUE: reference to a compiler-generated field
          this.m_CommandBuffer.AddComponent<Deleted>(jobIndex, entity, new Deleted());
          return true;
        }
        ...
        ref PathOwner pathOwner)
      {
        ...
        if (homeBuilding == Entity.Null && currentLane.m_Lane != Entity.Null)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.AddDeletedResident(ResidentAISystem.DeletedResidentType.NoPath_AlreadyMovingAway);
            // ISSUE: reference to a compiler-generated field
            if (this.m_CitizenData.HasComponent(resident.m_Citizen))
            {
              // ISSUE: reference to a compiler-generated field
        ...
        if ((currentLane.m_Flags & CreatureLaneFlags.Connection) != (CreatureLaneFlags) 0 && this.m_ConnectionLaneData.TryGetComponent(currentLane.m_Lane, out componentData) && (componentData.m_Flags & ConnectionLaneFlags.Outside) != (ConnectionLaneFlags) 0)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.AddDeletedResident(ResidentAISystem.DeletedResidentType.NoPathToHome_AlreadyOutside);
        }
        else
        {
          // ISSUE: reference to a compiler-generated method
          this.AddDeletedResident(ResidentAISystem.DeletedResidentType.NoPathToHome);
        }
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.AddComponent<Deleted>(jobIndex, entity, new Deleted());
        return true;
        ...
        ref PathOwner pathOwner)
      {
        ...
        if (this.m_PedestrianLaneData.HasComponent(currentLane.m_Lane))
        {
          ...
          DynamicBuffer<PathElement> pathElement = this.m_PathElements[entity];
          pathElement.Clear();
          NativeParallelHashSet<Entity> ignoreLanes = new NativeParallelHashSet<Entity>(16, (AllocatorManager.AllocatorHandle) Allocator.Temp);
...
label_17:
      ...
      private struct TransportEstimateBuffer : RouteUtils.ITransportEstimateBuffer
      {
        ...
        public void AddWaitEstimate(Entity waypoint, int seconds)
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          this.m_BoardingQueue.Enqueue(ResidentAISystem.Boarding.WaitTimeEstimate(waypoint, seconds));
        }
      }
    }
    ...
    private struct BoardingJob : IJob
    {
        ...
        int ticketPrice)
      {
        ...
        if (ticketPrice > 0)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.EnqueueStat(StatisticType.Income, ticketPrice, 10);
        ...
        out float distance)
      {
        ...
        return !isLeader || (int3.z & 1) != 0 && int3.x >= requiredSpace || (int3.z & 2) != 0 && int3.x == int3.y ? entity : Entity.Null;
      }
    ...
    private struct ResidentActionJob : IJob
    {
      ...
      private void SendMail(ResidentAISystem.ResidentAction action)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (!this.m_MailSenderData.TryGetEnabledComponent<MailSender>(action.m_Citizen, out component) || !this.m_MailBoxData.HasComponent(action.m_Target))
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        Game.Routes.MailBox mailBox = this.m_MailBoxData[action.m_Target];
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        MailBoxData mailBoxData = this.m_PrefabMailBoxData[this.m_PrefabRefData[action.m_Target].m_Prefab];
        int num = math.min((int) component.m_Amount, mailBoxData.m_MailCapacity - mailBox.m_MailAmount);
        if (num <= 0)
          return;
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.m_MailBoxData[action.m_Target] = mailBox;
