...
// Type: Game.Simulation.ResidentialDemandSystem
...
namespace Game.Simulation
{
  ...
  public class ResidentialDemandSystem : GameSystemBase, IDefaultSerializable, ISerializable
  {
    ...
    private ResidentialDemandSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      ResidentialDemandSystem.UpdateResidentialDemandJob jobData = new ResidentialDemandSystem.UpdateResidentialDemandJob()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.Schedule<ResidentialDemandSystem.UpdateResidentialDemandJob>(JobUtils.CombineDependencies(this.Dependency, this.m_ReadDependencies, outJobHandle, deps));
      // ISSUE: reference to a compiler-generated field
    ...
    private struct UpdateResidentialDemandJob : IJob
    {
      ...
      public void Execute()
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        float num5 = math.min((float) (-(double) demandParameter.m_HomelessEffect * (100.0 * (double) this.m_HouseholdCountData.m_HomelessHouseholdCount / (1.0 + (double) this.m_HouseholdCountData.m_MovedInHouseholdCount) - (double) demandParameter.m_NeutralHomelessness)), (float) ResidentialDemandSystem.kMaxFactorEffect);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        float f3 = math.clamp(demandParameter.m_HomelessEffect * ((float) (100.0 * (double) this.m_HouseholdCountData.m_HomelessHouseholdCount / (1.0 + (double) this.m_HouseholdCountData.m_MovedInHouseholdCount)) - demandParameter.m_NeutralHomelessness), 0.0f, (float) ResidentialDemandSystem.kMaxFactorEffect);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.m_HouseholdDemand.value = this.m_HouseholdCountData.m_MovingInHouseholdCount <= ResidentialDemandSystem.kMaxMovingInHouseholdAmount ? math.min(200, (int) ((double) num2 + (double) f2 + (double) num5 + (double) f1 + (double) f5 + (double) f4 + (double) math.max(num6, y))) : 0;
