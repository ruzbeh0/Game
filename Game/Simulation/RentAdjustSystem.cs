...
// Type: Game.Simulation.RentAdjustSystem
...
namespace Game.Simulation
{
  ...
  public class RentAdjustSystem : GameSystemBase
  {
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle = new RentAdjustSystem.AdjustRentJob()
      {
      ...
      }.ScheduleParallel<RentAdjustSystem.AdjustRentJob>(this.m_BuildingQuery, JobUtils.CombineDependencies(dependencies1, dependencies2, dependencies3, this.Dependency));
      // ISSUE: reference to a compiler-generated field
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index1 = 0; index1 < nativeArray.Length; ++index1)
        {
          ...
          if (this.m_BuildingProperties.HasComponent(prefab))
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            int rentPricePerRenter = PropertyUtils.GetRentPricePerRenter(this.m_ConsumptionDatas[prefab], buildingProperty, buildingLevel, lotSize, landValueBase, areaType, ref this.m_EconomyParameterData);
            // ISSUE: reference to a compiler-generated field
