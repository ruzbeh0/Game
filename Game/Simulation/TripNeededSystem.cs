...
// Type: Game.Simulation.TripNeededSystem
...
namespace Game.Simulation
{
  ...
  public class TripNeededSystem : GameSystemBase
  {
    ...
    private TripNeededSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_CompanyGroup = this.GetEntityQuery(ComponentType.ReadOnly<TransportCompany>(), ComponentType.ReadWrite<TripNeeded>(), ComponentType.ReadOnly<PrefabRef>(), ComponentType.ReadWrite<Game.Economy.Resources>(), ComponentType.ReadOnly<OwnedVehicle>(), ComponentType.Exclude<Deleted>(), ComponentType.Exclude<Temp>());
      // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      {
        NativeQueue<TripNeededSystem.AnimalTargetInfo> nativeQueue1 = new NativeQueue<TripNeededSystem.AnimalTargetInfo>((AllocatorManager.AllocatorHandle) Allocator.TempJob);
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.__TypeHandle.__Game_Citizens_CurrentBuilding_RW_ComponentTypeHandle.Update(ref this.CheckedStateRef);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.__TypeHandle.__Game_Citizens_CurrentTransport_RO_ComponentTypeHandle.Update(ref this.CheckedStateRef);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.__TypeHandle.__Game_Citizens_MailSender_RO_ComponentTypeHandle.Update(ref this.CheckedStateRef);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ...
        TripNeededSystem.CitizenJob jobData1 = new TripNeededSystem.CitizenJob()
        {
          ...
          m_MailSenderType = this.__TypeHandle.__Game_Citizens_MailSender_RO_ComponentTypeHandle,
          m_CurrentTransportType = this.__TypeHandle.__Game_Citizens_CurrentTransport_RO_ComponentTypeHandle,
          m_CurrentBuildingType = this.__TypeHandle.__Game_Citizens_CurrentBuilding_RW_ComponentTypeHandle,
          ...
          m_ObjectDatas = this.__TypeHandle.__Game_Prefabs_ObjectData_RO_ComponentLookup,
          ...
          m_PathQueue = this.m_PathfindSetupSystem.GetQueue((object) this, 80, 16).AsParallelWriter(),
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        TripNeededSystem.PetTargetJob jobData2 = new TripNeededSystem.PetTargetJob()
        {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        TripNeededSystem.CitizeLeaveJob jobData3 = new TripNeededSystem.CitizeLeaveJob()
        {
          m_CurrentBuildingData = this.__TypeHandle.__Game_Citizens_CurrentBuilding_RO_ComponentLookup,
        ...
        // ISSUE: reference to a compiler-generated field
        jobHandle1 = jobData1.ScheduleParallel<TripNeededSystem.CitizenJob>(this.m_CitizenGroup, jobHandle1);
        JobHandle jobHandle3 = jobData2.Schedule<TripNeededSystem.PetTargetJob>(jobHandle1);
        JobHandle dependsOn = jobHandle1;
        JobHandle jobHandle4 = jobData3.Schedule<TripNeededSystem.CitizeLeaveJob>(dependsOn);
      ...
      if (!this.m_CompanyGroup.IsEmptyIgnoreFilter)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.__TypeHandle.__Game_Companies_TransportCompanyData_RO_ComponentLookup.Update(ref this.CheckedStateRef);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.__TypeHandle.__Game_Objects_Transform_RO_ComponentLookup.Update(ref this.CheckedStateRef);
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: reference to a compiler-generated field
        jobHandle1 = new TripNeededSystem.CompanyJob()
        {
          m_EntityType = this.__TypeHandle.__Unity_Entities_Entity_TypeHandle,
          ...
          m_Transforms = this.__TypeHandle.__Game_Objects_Transform_RO_ComponentLookup,
          m_TransportCompanies = this.__TypeHandle.__Game_Companies_TransportCompanyData_RO_ComponentLookup,
          ...
          m_CommandBuffer = this.m_EndFrameBarrier.CreateCommandBuffer().AsParallelWriter(),
          m_DebugDisableSpawning = this.debugDisableSpawning
        }.ScheduleParallel<TripNeededSystem.CompanyJob>(this.m_CompanyGroup, jobHandle1);
        // ISSUE: reference to a compiler-generated field
    ...
    private struct CompanyJob : IJobChunk
    {
      ...
      [ReadOnly]
      public ComponentLookup<TransportCompanyData> m_TransportCompanies;
      [ReadOnly]
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < chunk.Count; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (this.m_TransportCompanies.HasComponent(prefab) && bufferAccessor1[index].Length < this.m_TransportCompanies[prefab].m_MaxTransports)
          {
            ...
            if (dynamicBuffer1.Length > 0)
            {
              ...
              if (!this.m_DebugDisableSpawning)
              {
                ...
                if (this.m_Transforms.HasComponent(entity))
                {
                  ...
                  // ISSUE: reference to a compiler-generated method
                  this.SpawnDeliveryTruck(unfilteredChunkIndex, owner, entity, ref transform, trip);
                }
              }
            }
          }
    ...
    private struct PetTargetJob : IJob
    {
      ...
      public NativeQueue<TripNeededSystem.AnimalTargetInfo> m_AnimalQueue;
      ...
      public void Execute()
      {
        ...
        for (int index = 0; index < count; ++index)
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: variable of a compiler-generated type
          TripNeededSystem.AnimalTargetInfo animalTargetInfo = this.m_AnimalQueue.Dequeue();
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
    ...
    private struct CitizenJob : IJobChunk
    {
      ...
      public NativeQueue<TripNeededSystem.AnimalTargetInfo>.ParallelWriter m_AnimalQueue;
...
label_11:
      ...
      private void AddPetTargets(Entity household, Entity source, Entity target)
      {
        ...
        for (int index = 0; index < householdAnimal1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: object of a compiler-generated type is created
          this.m_AnimalQueue.Enqueue(new TripNeededSystem.AnimalTargetInfo()
          {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          if (trips.Length > 0)
          {
            bool c = trips[0].m_Purpose == Game.Citizens.Purpose.MovingAway;
            // ISSUE: reference to a compiler-generated field
            ...
            if (nativeArray6.Length != 0)
            {
              ...
              if ((healthProblem.m_Flags & (HealthProblemFlags.Dead | HealthProblemFlags.RequireTransport | HealthProblemFlags.InDanger | HealthProblemFlags.Trapped)) != HealthProblemFlags.None)
              {
                ...
                flag = (healthProblem.m_Flags & HealthProblemFlags.RequireTransport) != 0;
                if (isDead | flag)
                {
            ...
            else
            {
              if (component1)
              {
                ...
                {
                  // ISSUE: reference to a compiler-generated field
                  if (componentData1.m_Origin != Entity.Null && componentData1.m_Origin == componentData1.m_Destination || nativeArray3[index].m_CurrentBuilding == componentData1.m_Destination || !this.m_Targets.HasComponent(entity1))
                  {
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    this.m_CommandBuffer.RemoveComponent(unfilteredChunkIndex, entity1, in this.m_PathfindTypes);
              ...
              if (!this.m_DebugDisableSpawning)
              {
                ...
                if (this.m_Targets.HasComponent(entity1))
                {
                  ...
                  {
                    bool isCarried = isDead && trips[0].m_Purpose == Game.Citizens.Purpose.Deathcare || flag && trips[0].m_Purpose == Game.Citizens.Purpose.Hospital;
                    if (!component1 && !isCarried)
                    {
                      ...
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated field
                      pathfindParameters.m_MaxCost = math.select(CitizenBehaviorSystem.kMaxPathfindCost, CitizenBehaviorSystem.kMaxMovingAwayCost, c);
                    ...
                    else
                    {
                      ...
                      if (!isCarried && dynamicBuffer.Length > 0 || this.m_PrefabRefData.HasComponent(tripNeeded.m_TargetAgent))
                      {
                        ...
                        if (!isCarried & component3 && currentBuilding2.Equals(componentData4.m_Property))
                        {
                          if (componentData1.m_Destination != Entity.Null)
                          {
                            ...
                            else if ((componentData1.m_Methods & PathMethod.Road) != (PathMethod) 0)
                            {
                              // ISSUE: reference to a compiler-generated field
                      ...
                      else
                      {
                        ...
                        {
                          // ISSUE: reference to a compiler-generated field
                          this.m_CommandBuffer.AddComponent<MovingAway>(unfilteredChunkIndex, household1);
                        }
                      }
                      // ISSUE: reference to a compiler-generated method
                      this.RemoveAllTrips(trips);
