...
// Type: Game.Simulation.TransportAircraftAISystem
...
namespace Game.Simulation
{
  ...
  public class TransportAircraftAISystem : GameSystemBase
  {
    ...
    private TransportAircraftAISystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle = new TransportAircraftAISystem.TransportAircraftTickJob()
      {
      ...
      }.ScheduleParallel<TransportAircraftAISystem.TransportAircraftTickJob>(this.m_VehicleQuery, this.Dependency);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
    ...
    private struct TransportAircraftTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        NativeArray<Aircraft> nativeArray8 = chunk.GetNativeArray<Aircraft>(ref this.m_AircraftType);
        // ISSUE: reference to a compiler-generated field
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          Aircraft aircraft = nativeArray8[index];
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, prefabRef, currentRoute, navigationLanes, passengers, serviceDispatches, isStopped, ref cargoTransport, ref publicTransport, ref aircraft, ref currentLane, ref pathOwner, ref target, ref odometer);
          nativeArray8[index] = aircraft;
        ...
        ref Odometer odometer)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(vehicleEntity, ref cargoTransport, ref publicTransport, ref aircraft, ref currentLane, ref pathOwner);
        ...
        if (!this.m_PrefabRefData.HasComponent(target.m_Target) || VehicleUtils.PathfindFailed(pathOwner))
        {
          ...
          if (VehicleUtils.IsStuck(pathOwner) || (cargoTransport.m_State & (CargoTransportFlags.Returning | CargoTransportFlags.DummyTraffic)) != (CargoTransportFlags) 0 || (publicTransport.m_State & (PublicTransportFlags.Returning | PublicTransportFlags.Launched | PublicTransportFlags.DummyTraffic)) != (PublicTransportFlags) 0)
          {
            // ISSUE: reference to a compiler-generated field
        ...
        {
          if ((cargoTransport.m_State & (CargoTransportFlags.Returning | CargoTransportFlags.DummyTraffic)) != (CargoTransportFlags) 0 || (publicTransport.m_State & (PublicTransportFlags.Returning | PublicTransportFlags.Launched | PublicTransportFlags.DummyTraffic)) != (PublicTransportFlags) 0)
          {
            if ((cargoTransport.m_State & CargoTransportFlags.Boarding) != (CargoTransportFlags) 0 || (publicTransport.m_State & PublicTransportFlags.Boarding) != (PublicTransportFlags) 0)
            {
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              if (this.StopBoarding(vehicleEntity, currentRoute, passengers, ref cargoTransport, ref publicTransport, ref target, ref odometer, false) && !this.SelectNextDispatch(jobIndex, vehicleEntity, currentRoute, navigationLanes, serviceDispatches, ref cargoTransport, ref publicTransport, ref aircraft, ref currentLane, ref pathOwner, ref target))
              {
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.AddComponent<Deleted>(jobIndex, vehicleEntity, new Deleted());
                return;
        ...
        if ((cargoTransport.m_State & CargoTransportFlags.Boarding) == (CargoTransportFlags) 0 && (publicTransport.m_State & PublicTransportFlags.Boarding) == (PublicTransportFlags) 0)
        {
          if ((cargoTransport.m_State & CargoTransportFlags.Returning) != (CargoTransportFlags) 0 || (publicTransport.m_State & PublicTransportFlags.Returning) != (PublicTransportFlags) 0)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              this.SelectNextDispatch(jobIndex, vehicleEntity, currentRoute, navigationLanes, serviceDispatches, ref cargoTransport, ref publicTransport, ref aircraft, ref currentLane, ref pathOwner, ref target);
            }
          }
          else if ((cargoTransport.m_State & CargoTransportFlags.Arriving) == (CargoTransportFlags) 0 && (publicTransport.m_State & (PublicTransportFlags.Arriving | PublicTransportFlags.Launched)) == (PublicTransportFlags) 0)
          {
            // ISSUE: reference to a compiler-generated method
        ...
        ref Target target)
      {
        ...
        if ((publicTransport.m_State & PublicTransportFlags.Launched) != (PublicTransportFlags) 0)
        ...
        if (this.m_PrefabHelicopterData.HasComponent(prefabRef.m_Prefab))
        {
          ...
          parameters.m_MaxSpeed = (float2) helicopterData.m_FlyingMaxSpeed;
        ...
        else
        {
          ...
          if (this.m_PrefabAirplaneData.HasComponent(prefabRef.m_Prefab))
          {
            ...
            parameters.m_MaxSpeed = (float2) airplaneData.m_FlyingSpeed.y;
        ...
        ref PathOwner pathOwner)
      {
        ...
        else if ((cargoTransport.m_State & (CargoTransportFlags.Returning | CargoTransportFlags.DummyTraffic)) != (CargoTransportFlags) 0 || (publicTransport.m_State & (PublicTransportFlags.Returning | PublicTransportFlags.DummyTraffic)) != (PublicTransportFlags) 0)
        {
        ...
        ref Target target)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        int a = this.m_WaypointData[target.m_Target].m_Index + 1;
        int index = math.select(a, 0, a >= routeWaypoint.Length);
        VehicleUtils.SetTarget(ref pathOwner, ref target, routeWaypoint[index].m_Waypoint);
      }
        ...
        ref Game.Vehicles.CargoTransport cargoTransport)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (this.m_TransportVehicleRequestData.HasComponent(publicTransport.m_TargetRequest) || this.m_TransportVehicleRequestData.HasComponent(cargoTransport.m_TargetRequest) || ((int) this.m_SimulationFrameIndex & (int) math.max(256U, 16U) - 1) != 10)
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ...
        ref Target target)
      {
        ...
        for (; cargoTransport.m_RequestCount + publicTransport.m_RequestCount > 0 && serviceDispatches.Length > 0; publicTransport.m_RequestCount = math.max(0, publicTransport.m_RequestCount - 1))
        {
          ...
          if (this.m_TransportVehicleRequestData.HasComponent(request))
          {
            ...
            aircraftFlags = aircraftFlags & ~AircraftFlags.StayMidAir | AircraftFlags.StayOnTaxiway;
          }
          // ISSUE: reference to a compiler-generated field
        ...
        bool isCargoVehicle)
      {
        ...
        if (this.m_ConnectedData.HasComponent(target.m_Target))
        {
          ...
          if (this.m_BoardingVehicleData.HasComponent(connected.m_Connected))
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              AircraftData aircraftData = this.m_PrefabAircraftData[prefabRef.m_Prefab];
              // ISSUE: reference to a compiler-generated field
              refuel = (this.m_TransportStationData[transportStationFromStop].m_AircraftRefuelTypes & EnergyTypes.Fuel) != 0;
            }
        ...
        out Connected connected)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return this.m_ConnectedData.TryGetComponent(target.m_Target, out connected) && this.m_BoardingVehicleData.TryGetComponent(connected.m_Connected, out componentData) && componentData.m_Vehicle == vehicleEntity;
      }
