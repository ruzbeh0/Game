...
// Type: Game.Simulation.StorageTransferSystem
...
namespace Game.Simulation
{
  ...
  public class StorageTransferSystem : GameSystemBase
  {
    ...
    private NativeQueue<StorageTransferSystem.StorageTransferEvent> m_TransferQueue;
    private StorageTransferSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_TransferQueue = new NativeQueue<StorageTransferSystem.StorageTransferEvent>((AllocatorManager.AllocatorHandle) Allocator.Persistent);
      // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle = new StorageTransferSystem.TransferJob()
      {
      ...
      }.ScheduleParallel<StorageTransferSystem.TransferJob>(this.m_TransferGroup, this.Dependency);
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: object of a compiler-generated type is created
      JobHandle handle = new StorageTransferSystem.HandleTransfersJob()
      {
      ...
      }.Schedule<StorageTransferSystem.HandleTransfersJob>(jobHandle);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
    ...
    private struct TransferJob : IJobChunk
    {
      ...
      public NativeQueue<StorageTransferSystem.StorageTransferEvent>.ParallelWriter m_TransferQueue;
      [ReadOnly]
            ...
            if (this.m_PathInformation.HasComponent(entity1))
            {
              ...
              if ((pathInformation.m_State & PathFlags.Pending) == (PathFlags) 0)
              {
                ...
                if (this.m_Properties.HasComponent(entity2) | flag1 && entity1 != entity2)
                {
                  ...
                  long resources3 = (long) EconomyUtils.GetResources(storageTransfer.m_Resource, resource);
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_StorageTransferRequests.HasBuffer(entity2))
                  {
                    ...
                    for (int index2 = 0; index2 < storageTransferRequest1.Length; ++index2)
                    {
                      ...
                      if (storageTransferRequest2.m_Resource == storageTransfer.m_Resource)
                        num4 += (storageTransferRequest2.m_Flags & StorageTransferFlags.Incoming) != (StorageTransferFlags) 0 ? (long) storageTransferRequest2.m_Amount : (long) -storageTransferRequest2.m_Amount;
                    }
                    resources3 += num4;
                  }
                  if (flag2 | flag1)
                  {
                    if (storageTransfer.m_Amount < 0)
                      storageTransfer.m_Amount = resources3 <= 0L ? 0 : -math.min((int) resources3, math.abs(storageTransfer.m_Amount));
                  }
                  else
                  {
                    // ISSUE: reference to a compiler-generated method
                    storageTransfer.m_Amount = StorageTransferSystem.CalculateTransferableAmount(storageTransfer.m_Amount, resources2, num2, (int) math.max(0L, resources3), targetCapacity);
                  }
                  ...
                  {
                    int num5 = math.abs(storageTransfer.m_Amount) / deliveryTruckSelectItem.m_Capacity * deliveryTruckSelectItem.m_Capacity;
                    if (num5 != 0)
                    {
                      // ISSUE: reference to a compiler-generated field
                      this.m_DeliveryTruckSelectData.TrySelectItem(ref random, storageTransfer.m_Resource, math.abs(storageTransfer.m_Amount) - num5, out deliveryTruckSelectItem);
                      // ISSUE: reference to a compiler-generated field
                      if (math.abs(storageTransfer.m_Amount) - num5 > 0 && (double) (deliveryTruckSelectItem.m_Cost / (math.abs(storageTransfer.m_Amount) - num5)) > (double) StorageTransferSystem.kMaxTransportUnitCost)
                    ...
                    if (storageTransfer.m_Amount != 0)
                    {
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: object of a compiler-generated type is created
                      this.m_TransferQueue.Enqueue(new StorageTransferSystem.StorageTransferEvent()
                      {
    ...
    {
      public NativeQueue<StorageTransferSystem.StorageTransferEvent> m_TransferQueue;
...
label_12:
      ...
      public void Execute()
      {
        ...
        StorageTransferSystem.StorageTransferEvent storageTransferEvent;
        // ISSUE: reference to a compiler-generated field
        while (this.m_TransferQueue.TryDequeue(out storageTransferEvent))
        {
          ...
          if (this.m_PathInfos.HasComponent(storageTransferEvent.m_Source) && this.m_Paths.HasBuffer(storageTransferEvent.m_Source))
          {
            ...
            // ISSUE: reference to a compiler-generated field
            int amount = Mathf.RoundToInt(StorageTransferSystem.kStorageProfit * num1);
            // ISSUE: reference to a compiler-generated field
