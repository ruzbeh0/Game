...
// Type: Game.Simulation.HearseAISystem
...
namespace Game.Simulation
{
  ...
  public class HearseAISystem : GameSystemBase
  {
    ...
    private HearseAISystem.TypeHandle __TypeHandle;
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.__TypeHandle.__Game_Vehicles_Hearse_RW_ComponentTypeHandle.Update(ref this.CheckedStateRef);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle = new HearseAISystem.HearseTickJob()
      {
        ...
        m_HearseType = this.__TypeHandle.__Game_Vehicles_Hearse_RW_ComponentTypeHandle,
      ...
      }.ScheduleParallel<HearseAISystem.HearseTickJob>(this.m_VehicleQuery, this.Dependency);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
    ...
    private struct HearseTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        NativeArray<Game.Vehicles.Hearse> nativeArray6 = chunk.GetNativeArray<Game.Vehicles.Hearse>(ref this.m_HearseType);
        // ISSUE: reference to a compiler-generated field
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          Game.Vehicles.Hearse hearse = nativeArray6[index];
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, prefabRef, pathInformation, navigationLanes, passengers, serviceDispatches, isStopped, ref random, ref hearse, ref car, ref currentLane, ref pathOwner, ref target);
          nativeArray6[index] = hearse;
      ...
      private void Tick(
        ...
        bool isStopped,
        ref Random random,
        ref Game.Vehicles.Hearse hearse,
        ref Car car,
      ...
      {
        // ISSUE: reference to a compiler-generated method
        this.CheckServiceDispatches(entity, serviceDispatches, ref hearse);
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.RequestTargetIfNeeded(jobIndex, entity, ref hearse);
        }
        if (VehicleUtils.ResetUpdatedPath(ref pathOwner))
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(jobIndex, entity, pathInformation, serviceDispatches, ref random, ref hearse, ref car, ref currentLane, ref pathOwner, ref target);
        }
        // ISSUE: reference to a compiler-generated field
        if (!this.m_EntityLookup.Exists(target.m_Target) || VehicleUtils.PathfindFailed(pathOwner))
        {
          if (VehicleUtils.IsStuck(pathOwner) || (hearse.m_State & HearseFlags.Returning) != (HearseFlags) 0)
          {
            // ISSUE: reference to a compiler-generated field
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.ReturnToDepot(owner, serviceDispatches, ref hearse, ref car, ref pathOwner, ref target);
          }
        }
        else
        {
          if (VehicleUtils.PathEndReached(currentLane) || VehicleUtils.ParkingSpaceReached(currentLane, pathOwner) || (hearse.m_State & (HearseFlags.AtTarget | HearseFlags.Disembarking)) != (HearseFlags) 0)
          {
            if ((hearse.m_State & HearseFlags.Returning) != (HearseFlags) 0)
            {
              // ISSUE: reference to a compiler-generated method
              if (!this.UnloadCorpses(passengers, ref hearse))
                return;
              if (VehicleUtils.ParkingSpaceReached(currentLane, pathOwner))
              {
                // ISSUE: reference to a compiler-generated method
                this.ParkCar(jobIndex, entity, owner, ref hearse, ref currentLane);
                return;
              }
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.AddComponent<Deleted>(jobIndex, entity, new Deleted());
            ...
            if ((hearse.m_State & HearseFlags.Transporting) != (HearseFlags) 0)
            {
              // ISSUE: reference to a compiler-generated method
              if (!this.UnloadCorpses(passengers, ref hearse))
                return;
              // ISSUE: reference to a compiler-generated method
              if (!this.SelectDispatch(jobIndex, entity, navigationLanes, serviceDispatches, ref hearse, ref car, ref currentLane, ref pathOwner, ref target))
              {
                // ISSUE: reference to a compiler-generated method
                this.ReturnToDepot(owner, serviceDispatches, ref hearse, ref car, ref pathOwner, ref target);
              }
            ...
            {
              // ISSUE: reference to a compiler-generated method
              if (this.LoadCorpses(jobIndex, entity, passengers, serviceDispatches, isStopped, ref hearse, ref currentLane, ref target))
              {
                if ((hearse.m_State & HearseFlags.Transporting) != (HearseFlags) 0)
                {
                  // ISSUE: reference to a compiler-generated method
                  this.TransportToFacility(owner, serviceDispatches, ref hearse, ref car, ref pathOwner, ref target);
                }
                else
                {
                  // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          if ((hearse.m_State & (HearseFlags.Returning | HearseFlags.Dispatched | HearseFlags.Transporting)) == (HearseFlags.Returning | HearseFlags.Dispatched) && !this.SelectDispatch(jobIndex, entity, navigationLanes, serviceDispatches, ref hearse, ref car, ref currentLane, ref pathOwner, ref target))
          {
            serviceDispatches.Clear();
            hearse.m_State &= ~HearseFlags.Dispatched;
          }
          if ((hearse.m_State & (HearseFlags.AtTarget | HearseFlags.Disembarking)) != (HearseFlags) 0)
            return;
          if (VehicleUtils.RequireNewPath(pathOwner))
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              this.FindNewPath(entity, prefabRef, ref hearse, ref car, ref currentLane, ref pathOwner, ref target);
            }
          }
          else
          {
            if ((pathOwner.m_State & (PathFlags.Pending | PathFlags.Failed | PathFlags.Stuck)) != (PathFlags) 0)
              return;
            // ISSUE: reference to a compiler-generated method
            this.CheckParkingSpace(entity, ref random, ref hearse, ref currentLane, ref pathOwner, navigationLanes);
          }
        }
      }
      ...
      private void ParkCar(
        ...
        ref CarCurrentLane currentLane)
      {
        hearse.m_State = (HearseFlags) 0;
        Game.Buildings.DeathcareFacility componentData;
        // ISSUE: reference to a compiler-generated field
        if (this.m_DeathcareFacilityData.TryGetComponent(owner.m_Owner, out componentData) && (componentData.m_Flags & DeathcareFacilityFlags.HasAvailableHearses) == (DeathcareFacilityFlags) 0)
        ...
        ref Target target)
      {
        ...
        bool flag = false;
        if (serviceDispatches.Length == 0 || (hearse.m_State & HearseFlags.Dispatched) == (HearseFlags) 0)
        {
          hearse.m_TargetCorpse = Entity.Null;
          return true;
        }
        // ISSUE: reference to a compiler-generated field
        if (!this.m_HealthProblemData.HasComponent(hearse.m_TargetCorpse))
        {
          hearse.m_TargetCorpse = Entity.Null;
          return true;
        }
        // ISSUE: reference to a compiler-generated field
        HealthProblem healthProblem = this.m_HealthProblemData[hearse.m_TargetCorpse];
        ...
        // ISSUE: reference to a compiler-generated field
        if (this.m_CurrentBuildingData.TryGetComponent(hearse.m_TargetCorpse, out componentData1) && componentData1.m_CurrentBuilding != Entity.Null)
          flag |= componentData1.m_CurrentBuilding == target.m_Target;
        CurrentTransport componentData2;
        // ISSUE: reference to a compiler-generated field
        if (this.m_CurrentTransportData.TryGetComponent(hearse.m_TargetCorpse, out componentData2) && componentData2.m_CurrentTransport != Entity.Null)
        {
          flag |= componentData2.m_CurrentTransport == target.m_Target;
          TravelPurpose componentData3;
          // ISSUE: reference to a compiler-generated field
          if (!flag && (this.m_TravelPurposeData.TryGetComponent(hearse.m_TargetCorpse, out componentData3) && componentData3.m_Purpose == Game.Citizens.Purpose.Hospital || componentData3.m_Purpose == Game.Citizens.Purpose.Deathcare))
            flag = true;
          if (flag)
          {
      ...
      private void TransportToFacility(
        Owner owner,
        DynamicBuffer<ServiceDispatch> serviceDispatches,
        ref Game.Vehicles.Hearse hearse,
        ref Car car,
        ...
        ref Game.Vehicles.Hearse hearse)
      {
        if ((hearse.m_State & HearseFlags.Transporting) != (HearseFlags) 0)
          serviceDispatches.Clear();
        else if ((hearse.m_State & HearseFlags.Dispatched) != (HearseFlags) 0)
        {
      ...
      private void RequestTargetIfNeeded(int jobIndex, Entity entity, ref Game.Vehicles.Hearse hearse)
      {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (this.m_HealthcareRequestData.HasComponent(hearse.m_TargetRequest) || ((int) this.m_SimulationFrameIndex & (int) math.max(256U, 16U) - 1) != 11)
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
      ...
      private bool SelectDispatch(
        ...
        ref Target target)
      {
        if ((hearse.m_State & HearseFlags.Returning) == (HearseFlags) 0 && (hearse.m_State & HearseFlags.Dispatched) != (HearseFlags) 0 && serviceDispatches.Length > 0)
        {
          serviceDispatches.RemoveAt(0);
          hearse.m_State &= ~HearseFlags.Dispatched;
        }
        if ((hearse.m_State & HearseFlags.Disabled) != (HearseFlags) 0)
        {
          serviceDispatches.Clear();
          return false;
        }
        for (; (hearse.m_State & HearseFlags.Dispatched) != (HearseFlags) 0 && serviceDispatches.Length > 0; hearse.m_State &= ~HearseFlags.Dispatched)
        {
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (this.m_HealthcareRequestData.HasComponent(hearse.m_TargetRequest))
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Entity entity3 = this.m_CommandBuffer.CreateEntity(jobIndex, this.m_HandleRequestArchetype);
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity3, new HandleRequest(hearse.m_TargetRequest, Entity.Null, true));
            }
            // ISSUE: reference to a compiler-generated field
            if (this.m_PathElements.HasBuffer(request))
            {
              ...
              if (pathElement1.Length != 0)
              {
                ...
                // ISSUE: reference to a compiler-generated field
                float num = hearse.m_PathElementTime * (float) pathElement2.Length + this.m_PathInformationData[request].m_Duration;
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                ...
                {
                  hearse.m_PathElementTime = num / (float) math.max(1, pathElement2.Length);
        ...
        DynamicBuffer<CarNavigationLane> navigationLanes)
      {
        ...
        bool flag = (hearse.m_State & HearseFlags.Returning) == (HearseFlags) 0;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ...
        ref Target target)
      {
        ...
        hearse.m_PathElementTime = pathInformation.m_Duration / (float) math.max(1, pathElement.Length);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ...
        bool ignoreDriveways = (hearse.m_State & HearseFlags.Returning) == (HearseFlags) 0;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
    ...
    private struct TypeHandle
    {
      ...
      public void __AssignHandles(ref SystemState state)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        this.__Game_Vehicles_Hearse_RW_ComponentTypeHandle = state.GetComponentTypeHandle<Game.Vehicles.Hearse>();
        // ISSUE: reference to a compiler-generated field
