...
// Type: Game.Tutorials.TutorialControlSchemeActivationSystem
...
namespace Game.Tutorials
{
  ...
  public class TutorialControlSchemeActivationSystem : GameSystemBase
  {
    ...
    private TutorialControlSchemeActivationSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_TutorialQuery = this.GetEntityQuery(ComponentType.ReadOnly<TutorialData>(), ComponentType.ReadOnly<ControlSchemeActivationData>(), ComponentType.Exclude<TutorialCompleted>(), ComponentType.Exclude<TutorialActivated>());
    }
    ...
    {
      // ISSUE: reference to a compiler-generated field
      if (this.m_TutorialQuery.IsEmptyIgnoreFilter || InputManager.instance == null)
        return;
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      TutorialControlSchemeActivationSystem.ActivateJob jobData = new TutorialControlSchemeActivationSystem.ActivateJob()
      {
        m_ControlSchemeActivationType = this.__TypeHandle.__Game_Tutorials_ControlSchemeActivationData_RO_ComponentTypeHandle,
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.ScheduleParallel<TutorialControlSchemeActivationSystem.ActivateJob>(this.m_TutorialQuery, this.Dependency);
      // ISSUE: reference to a compiler-generated field
    ...
    private struct ActivateJob : IJobChunk
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        NativeArray<ControlSchemeActivationData> nativeArray1 = chunk.GetNativeArray<ControlSchemeActivationData>(ref this.m_ControlSchemeActivationType);
        // ISSUE: reference to a compiler-generated field
